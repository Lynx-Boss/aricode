...
int call_is_xmm_safe(const char *fn) {
    ...
    if (strcmp(fn, "arr_i4_matvec_f32_perrow") == 0) return 1;
...
int call_needs_ymm_save(const char *fn) {
    ...
    if (strcmp(fn, "arr_f32_conv2d_3x3_p1_multi")== 0) return 1;
    if (strcmp(fn, "arr_i8_conv2d_3x3_p1")       == 0) return 1;
    if (strcmp(fn, "arr_i8_conv2d_3x3_p1_multi") == 0) return 1;
