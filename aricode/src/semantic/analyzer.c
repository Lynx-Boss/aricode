...
static AriType *builtin_return_type(const char *name) {
    ...
    static const struct { const char *name; TypeKind kind; } table[] = {
        ...
        {"arr_f32_scale",      TYPE_I32},
        {"arr_f32_fill",       TYPE_I32},
        {"arr_f32_add_scaled", TYPE_I32},
        ...
        {"arr_f64_tanh",    TYPE_I32},
        {"arr_f64_sub",     TYPE_I32},
        {"arr_f64_mul",     TYPE_I32},
        {"arr_f64_matvec_T", TYPE_I32},
        {"arr_f64_outer_accum", TYPE_I32},
        {"arr_f64_softmax", TYPE_I32},
        /* i32 — threading */
