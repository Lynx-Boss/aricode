...
Benchmarks across 14 computational challenges (154 binaries, 12 implementations including GCC, Clang, Rust, and Go) demonstrate that Aricode places second overall behind hand-optimized NASM assembly, while producing binaries 72{,}000$\times$ smaller than Rust and 12{,}000$\times$ smaller than Go. To our knowledge, no other project combines direct native code generation, zero runtime dependencies, and explicit design for AI agent use. Aricode establishes a new paradigm: instead of AI writing human code for human compilers, AI writes machine-optimal code for a machine-optimal compiler.
\end{abstract}

\textbf{Keywords:} AI agents, compilation target, code generation, x86\_64, machine code, zero runtime, binary optimization, LLM, autonomous coding
